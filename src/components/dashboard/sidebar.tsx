...
export default function Sidebar() {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    },
    {
      ...
      href: "/dashboard/field-management",
      icon: Layout,
    },
    {
      title: "Weather",
    ...
    },
    {
      ...
      icon: ShoppingBag,
      submenu: [
        { title: "My Products", href: "/dashboard/market/my-products" },
        { title: "Marketplace", href: "/dashboard/market/marketplace" },
        { title: "Shopping Cart", href: "/dashboard/market copy/cart" },
      ],
    },
    {
      title: "Map",
